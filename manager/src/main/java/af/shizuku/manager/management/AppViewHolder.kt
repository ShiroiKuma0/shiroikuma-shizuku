                        ...
                        add(LpAction(freezeLabel) {
                            CoroutineScope(Dispatchers.IO).launch {
                                try {
                                    ...
                                    withContext(Dispatchers.Main) {
                                        if (success) {
                                            ShiroikumaToast.show(context, if (isFrozen) "App unfrozen" else "App frozen", Toast.LENGTH_SHORT)
                                            ...
                                            ShiroikumaToast.show(context, "Operation failed", Toast.LENGTH_SHORT)
                                        }
                                    }
                                } catch (e: Exception) {
                                    withContext(Dispatchers.Main) {
                                        ShiroikumaToast.show(context, "Error: ${e.message}", Toast.LENGTH_SHORT)
                                    }
                                }
                            }
                        })
